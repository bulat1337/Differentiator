...
int main()
{
    struct B_tree_node *node_1 = create_node(OP , {.op_value = COS}, NULL, NULL).arg.node;
    ...
    struct B_tree_node *node_3 = create_node(OP , {.op_value = POW}, NULL, NULL).arg.node;
	...
	add_child(node_1, node_2, RIGHT_CHILD);
